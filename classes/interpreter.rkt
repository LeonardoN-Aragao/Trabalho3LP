...
; Inicializa o ambiente the-class com cada uma das classes declaradas no programa, passadas pela função initialize-class-env!
...
; Procura e retorna (se existir) a classe de nome no ambiente the-class
(define find-class    
  (lambda (name)
    (let ((maybe-pair 
            (assf 
